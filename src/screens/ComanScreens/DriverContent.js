export const driverContent = {
  ...
  // driver photo
  photoTitle: 'Take your photo',
  photoTxt: `So how did the classical Latin become so incoherent? According to McClintock, a 15th century typesetter likely scrambled part of Cicero's De Finibus in order to provide placeholder text to mockup various fonts for a type specimen book.
  ...
  // vehicle
  vehicleTitle: `Vehicle Registration Book`,
  vehicleTxt: `So how did the classical Latin become so incoherent? According to McClintock, a 15th century typesetter likely scrambled part of Cicero's De Finibus in order to provide placeholder text to mockup various fonts for a type specimen book.`,
  vehicleTitleTwo: 'Fill And Attach Documents',

  // approval
  approvalTitle: `Waiting for your Approval... `,
  approvalTxt: `your approval request is being processed, please wait`,
};
